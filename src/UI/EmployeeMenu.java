...
public class EmployeeMenu implements Initializable {
    ...
    public void switchToEquipment(MouseEvent event) throws IOException {
		...
		root = FXMLLoader.load(getClass().getResource("employeeRequisition.fxml"));
    ...
    public void switchToprofile(MouseEvent event) throws IOException {
    	...
    	addprofileEmployeee emp = new addprofileEmployeee();
    ...
    public void complaint(MouseEvent event) throws IOException {
    	
    	
		root = FXMLLoader.load(getClass().getResource("EmployeeComplaint.fxml"));
		stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
		scene = new Scene(root);
		stage.setScene(scene);
		stage.show();
